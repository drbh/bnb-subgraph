    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    require('execa')(utils_1.head(args), utils_1.tail(args), options)
...
function spawn(commandLine, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var args = commandLine.split(' ');
                    var spawned = require('cross-spawn')(utils_1.head(args), utils_1.tail(args), options);
                    var result = {
                        stdout: null,
                        status: null,
                        error: null,
                    ...
                    if (spawned.stdout) {
                        spawned.stdout.on('data', function (data) {
                            if (utils_1.isNil(result.stdout)) {
                                result.stdout = data;
                            }
                            else {
                                result.stdout += data;
