...
test('can create a new boilerplate JavaScript cli', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                process.chdir(tmp);
                return [4 /*yield*/, cli_1.run('new foo --javascript')];
            case 1:
                toolbox = _a.sent();
            ...
            case 3:
                ...
                return [4 /*yield*/, toolbox.system.exec("node " + tmp + "/foo/bin/foo --help")];
            case 4:
                runCommand = _a.sent();
                ...
                return [4 /*yield*/, toolbox.system.exec("node " + tmp + "/foo/bin/foo g flub")];
            case 5:
                genCommand = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                testResults = _a.sent();
                expect(testResults).toContain('jest');
                return [4 /*yield*/, toolbox.system.exec("node " + tmp + "/foo-ts/bin/foo-ts --help")];
            case 4:
                runCommand = _a.sent();
                cleanCmd = stripANSI(runCommand);
                expect(cleanCmd).toMatch(/version \(v\)/);
                ...
                expect(cleanCmd).toMatch(/generate \(g\)/);
                expect(cleanCmd).toMatch(/help \(h\)/);
                return [4 /*yield*/, toolbox.system.exec("node " + tmp + "/foo-ts/bin/foo-ts g flub")];
            case 5:
                genCommand = _a.sent();
                console.log(genCommand);
            ...
            case 6:
                ...
                return [4 /*yield*/, toolbox.system.exec("node " + tmp + "/foo-ts/bin/foo-ts kitchen")];
            case 7:
