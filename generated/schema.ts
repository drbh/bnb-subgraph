...
export class Freeze extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Freeze entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Freeze", id.toString(), this);
  }

  static load(id: string): Freeze | null {
    return store.get("Freeze", id) as Freeze | null;
  }
...
export class Unfreeze extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Unfreeze entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Unfreeze", id.toString(), this);
  }

  static load(id: string): Unfreeze | null {
    return store.get("Unfreeze", id) as Unfreeze | null;
  }
